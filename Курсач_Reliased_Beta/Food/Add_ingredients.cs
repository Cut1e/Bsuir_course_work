...
namespace Food
{
    public partial class Add_ingredients : Form
    {
        ...
        private void Add_ingredients_Load(object sender, EventArgs e)
        {
        ...
        public void add()
        {
            ...
            if (main != null)
            {
                main.add_ingredietns(bunifuTextBox1.Text, Convert.ToInt32(bunifuTextBox2.Text), id2, id);
            }
        }
