...
namespace Food
{
    public partial class Users_ingredients : Form
    {
        string user_login;
        public Users_ingredients(string user_login_)
        {
            InitializeComponent();
            user_login = user_login_;
        }

        private void Users_ingredients_Load(object sender, EventArgs e)
        {
        ...
        private void bunifuFlatButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                this.ingredientsTableAdapter.Fill(this.foodDataSet.Ingredients);
                MessageBox.Show("Таблица  обновлена!", "Внимание!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch
            {
                MessageBox.Show("Упс..Что-то пошло не так", "Ошибка!", MessageBoxButtons.OK, MessageBoxIcon.Error);
